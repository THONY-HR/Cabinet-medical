        ...
        <div className="flex">
            ...
            <aside className="w-64 h-screen bg-gray-800 text-white flex flex-col py-8 px-4 shadow-lg fixed top-0 left-0 z-40">
                ...
                <nav className="flex flex-col gap-6">
                    <div className="mb-8 text-1xl font-bold text-center">User Panel</div>
                    <Link className="hover:bg-gray-700 rounded px-3 py-2 transition-colors" href="/client/list-consultation">Liste consultation</Link>
                    <Link className="hover:bg-gray-700 rounded px-3 py-2 transition-colors" href="/client/consultation">Consultation</Link>
                </nav>
            </aside>
